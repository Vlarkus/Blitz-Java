...
public class ModelsConfig {
    ...
    public static final double CONTROL_POINT_DEFAULT_R_START = 0.5;
    public static final double CONTROL_POINT_DEFAULT_THETA_START = 0;
    public static final double CONTROL_POINT_DEFAULT_R_END = 0.5;
